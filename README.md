...
1. Abrir el archivo del programa (codigo gui) en Python.  
2. Ejecutar el programa.
3. Seleccionar una opcion del menu haciendo click sobre ella.
4. Ingresar los datos solicitados para cada operacion.
6. Repetir las acciones que se deseen realizar.
7. Elegir la opción 5 -Salir para finalizar la ejecución del sistema.
