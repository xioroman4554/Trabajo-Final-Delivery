...
Participantes: Arroyo Federico, Bilunyk Ivan, Encina Patricio, Roman Xiomara, Valdez Estrella
...
1. Abrir el archivo del programa en Python.  
2. Ejecutar el programa.
3. Seleccionar una opcion del menu escribiendo el número correspondiente.
4. Ingresar los datos solicitados para cada operacion.
5. Repetir las acciones que se deseen realizar.
6. Elegir la opción 5 -Salir para finalizar la ejecución del sistema.
